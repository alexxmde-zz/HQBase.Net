...
namespace HQBase.Controllers
{
    public class WritersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="WriterId,Name,LastName,BirthDate,Country")] Writer writer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="WriterId,Name,LastName,BirthDate,Country")] Writer writer)
        {
            if (ModelState.IsValid)
            {
